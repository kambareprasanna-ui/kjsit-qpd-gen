    ...
    <header className="border-b border-border bg-card sticky top-0 z-40 no-print">
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          {user.role === "hod" && (
            <span className="hidden md:inline-flex items-center text-xs font-semibold px-2.5 py-1 rounded bg-red-100 text-red-900">
              HOD Administration Portal
            </span>
          )}
        </div>
